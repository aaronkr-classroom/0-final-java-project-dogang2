...
public class CartltemListPage extends JPanel{
	...
	public CartltemListPage (JPanel panel, Cart cart) {
		Font ft;
	...
	public static void main(String[] args) {
		...
		mPagePanel.add("장바구니의 상품 목록 보기", new CartltemListPage(mPagePanel, mCart));
