...
public class GusetInfoPage extends JPanel {
   public GusetInfoPage(JPanel panel) {
      Font ft;
      ft = new Font("함조롬돋움", Font.BOLD, 15);
      setLayout(null);
   ...
   public static void main(String[] args) {
      ...
      mPagePanel.add("고객 정보 확인하기", new GusetInfoPage(mPagePanel));
